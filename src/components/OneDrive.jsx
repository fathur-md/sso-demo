    ...
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <defs>
          ...
          >
            {" "}
            <stop stop-color="#2086B8"></stop>{" "}
            <stop offset="1" stop-color="#46D3F6"></stop>{" "}
          </linearGradient>{" "}
          <linearGradient
          ...
          >
            {" "}
            <stop stop-color="#1694DB"></stop>{" "}
            <stop offset="1" stop-color="#62C3FE"></stop>{" "}
          </linearGradient>{" "}
          <linearGradient
          ...
          >
            {" "}
            <stop stop-color="#0D3D78"></stop>{" "}
            <stop offset="1" stop-color="#063B83"></stop>{" "}
          </linearGradient>{" "}
          <linearGradient
          ...
          >
            {" "}
            <stop stop-color="#16589B"></stop>{" "}
            <stop offset="1" stop-color="#1464B7"></stop>{" "}
          </linearGradient>{" "}
        </defs>{" "}
      </g>
    </svg>
