  ...
  return (
    <div className="mx-auto max-w-sm pt-6">
      ...
      >
        ...
        <div className="relative">
          <label>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 px-10 py-3 focus:outline-none"
              value={form.password}
              onChange={handleChange}
        ...
        <button
          type="submit"
          className="rounded-md bg-blue-900 p-3 font-medium text-white transition-all active:scale-95"
        >
          Login
        </button>
      </form>
